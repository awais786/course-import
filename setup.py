#!/usr/bin/env python
"""
Package metadata for course_import.
"""
import os
import re
import sys
...
VERSION = get_version('course_import', '__init__.py')
...
setup(
    ...
    url='https://github.com/edly/course-import',
    packages=find_packages(
        include=['course_import', 'course_import.*'],
        exclude=["*tests"],
    ),
