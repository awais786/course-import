...
extract_translations: ## extract strings to be translated, outputting .mo files
	rm -rf docs/_build
	cd course_import && i18n_tool extract --no-segment

compile_translations: ## compile translation files, outputting .po files for each supported language
	cd course_import && i18n_tool generate

detect_changed_source_translations:
	cd course_import && i18n_tool changed
...
pull_translations:
	find course_import/conf/locale -mindepth 1 -maxdepth 1 -type d -exec rm -r {} \;
	atlas pull $(OPENEDX_ATLAS_ARGS) translations/course-import/course_import/conf/locale:course_import/conf/locale
...
dummy_translations: ## generate dummy translation (.po) files
	cd course_import && i18n_tool dummy
