...
"""
course-import documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'course-import',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edly/course-import",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'course_import'),
                os.path.join(root_path, 'course_import/migrations')])
